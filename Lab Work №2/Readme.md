...
## Диаграмма компонентов (Инвестиционный портфель)

Для поддержки доступа к платформам система хранит и актуализирует API-ключи к платформам.

![Диаграмма Компонентов (Инвестиционный портфель)](Component-Invest.png)
